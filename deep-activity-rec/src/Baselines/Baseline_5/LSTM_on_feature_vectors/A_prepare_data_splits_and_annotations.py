"""
this script will be also adapoted in baseline-6
...
"""
it was mine : 
with open(f'/kaggle/input/volleybal-annotations-for-all-the-dataset-77a/annot_all.pkl', 'rb') as file:
...
def get_person_lvl_annot() :
    train_dict_person_level_labels = get_train_annotations()
    val_dict_person_level_labels = get_val_annotations()
    test_dict_person_level_labels = get_test_annotations()

    return train_dict_person_level_labels , val_dict_person_level_labels , test_dict_person_level_labels
...
if __name__ == "__main__" :
    ...
    train_dataset , val_dataset , test_dataset = split_tra_val_test()