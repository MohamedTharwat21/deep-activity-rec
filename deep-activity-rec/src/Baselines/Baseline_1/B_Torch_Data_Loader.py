...
# import train val test datasets
from A_get_data import load_pickle_files
...
if True : 
    ...
    # Create a DataLoader
    val_loader = DataLoader(custom_val_data, batch_size=32, shuffle= False )


    custom_test_data = VolleyballDataset(test_dataset, transform=transform['test'])
    # Create a DataLoader
    test_loader = DataLoader(custom_test_data, batch_size=32, shuffle= False )
