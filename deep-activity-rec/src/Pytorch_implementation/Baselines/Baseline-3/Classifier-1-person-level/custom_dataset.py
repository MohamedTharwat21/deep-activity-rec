...
class_to_idx = {cls: idx for idx, cls in enumerate(sorted(set(val_labels)))}
print(class_to_idx)
...
custom_train_dataset = VolleyballDataset(train_images , train_labels, transform= None )
custom_val_dataset = VolleyballDataset(val_images , val_labels, transform=data_transforms['val'])
custom_test_dataset = VolleyballDataset(test_images , test_labels , transform=data_transforms['test'])
